...
function Home({filteredMovies}) {
  ...
  return (
    ...
    {console.log(filteredMovies)}
        ...
        {filteredMovies.length !== 0 && filteredMovies !=undefined ?
      ...
      <Button onClick={prevPage}variant="secondary rounded-0">Previous</Button>
      <Button onClick={nextPage} variant="secondary rounded-0">Next</Button>
    </ButtonGroup>
    </>
  )
}
